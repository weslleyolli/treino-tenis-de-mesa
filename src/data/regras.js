...
export const REGRAS = [
  ...
  {
    id: "r-lad-so-bh", cat: "lados", nivel: 2,
    nome: "Só backhand, no lado do backhand",
    resumo: "O ponto inteiro acontece na metade do backhand dos dois, e só vale bater de backhand.",
    comoFunciona: [
      "Metade da mesa sai do jogo: só vale a metade do lado do backhand, dos dois lados da rede.",
      "Toda bola tem que cair nessa metade combinada — e tem que ser jogada de backhand.",
      "O saque entra na regra: ele também sai de backhand e cai nessa metade.",
    ],
    vale: "Todas as bolas do ponto, saque incluído, para os dois.",
    punicao: "Mandou a bola fora da metade combinada, ou bateu de forehand: ponto do adversário.",
    juiz: "Duas coisas só: onde a bola caiu e qual lado da raquete tocou nela. Metade errada ou golpe errado, canta.",
    duvidas: [
      { p: "Qual é 'o lado do backhand' com dois destros?", r: "É a diagonal: o seu backhand manda para o backhand dele, que fica do lado oposto da mesa em relação ao seu. É a diagonal clássica de backhand." },
      { p: "E se um for canhoto?", r: "Aí o backhand dos dois cai no mesmo lado físico da mesa e a troca vira uma linha reta em vez de diagonal. Funciona igual — olhem a mesa juntos antes do primeiro ponto e apontem qual metade vale." },
      { p: "A bola veio na metade errada. Eu devolvo ou deixo passar?", r: "Deixa passar: o ponto já é seu. Devolver só cria discussão sobre quem errou primeiro." },
      { p: "A bola caiu em cima da linha do meio.", r: "Linha do meio é boa. Só é falta o que cai claramente na metade proibida." },
    ],
    aviso: "É o exercício de diagonal de backhand virado jogo: em vez de treinar dez minutos e esquecer, o placar cobra. Junto com a de forehand abaixo, é o par que mais constrói regularidade.",
  },
  {
    id: "r-lad-so-fh", cat: "lados", nivel: 2,
    nome: "Só forehand, no lado do forehand",
    resumo: "O ponto inteiro acontece na metade do forehand dos dois, e só vale bater de forehand.",
    comoFunciona: [
      "Metade da mesa sai do jogo: só vale a metade do lado do forehand, dos dois lados da rede.",
      "Toda bola tem que cair nessa metade combinada — e tem que ser jogada de forehand.",
      "O saque entra na regra: ele também sai de forehand e cai nessa metade.",
    ],
    vale: "Todas as bolas do ponto, saque incluído, para os dois.",
    punicao: "Mandou a bola fora da metade combinada, ou bateu de backhand: ponto do adversário.",
    juiz: "Onde a bola caiu e qual lado da raquete tocou nela. Nada além disso.",
    duvidas: [
      { p: "Qual é 'o lado do forehand' com dois destros?", r: "É a diagonal do forehand, a outra metade da mesa em relação à regra do backhand. Se vocês jogaram a de backhand antes, é exatamente a metade que sobrou." },
      { p: "E se um for canhoto?", r: "O forehand dos dois cai no mesmo lado físico e a troca vira linha reta. Apontem a metade que vale antes do primeiro ponto." },
      { p: "A bola veio bem para o meio. Posso pegar de forehand?", r: "Se ela CAIU na metade que vale, sim — pega como conseguir, desde que seja de forehand. O que decide é onde a bola quicou, não onde você estava." },
      { p: "Não alcancei a bola na ponta da metade.", r: "Ponto do adversário, normal. Meia mesa parece pequena até você ter que cobrir a diagonal inteira." },
    ],
    aviso: "O par da regra de cima. Alternadas em rodízios seguidos, elas cobrem os dois lados sem ninguém precisar de robô nem de alguém alimentando.",
  },
  {
    ...
    comoFunciona: [
      ...
      "A mesa inteira continua valendo: esta regra prende o GOLPE, não a metade — é o contrário das duas de meia mesa acima.",
    ],
