...
const FISICO = {
  A: {
    ...
    exercicios: [
      { det: "fis-agachamento", nome: "Agachamento", dose: { 1: "3 × 12", 2: "4 × 6", 3: "4 × 3 explosivo" },
        cue: "Desça até a coxa passar da paralela. A subida é sempre rápida — é ela que vira arranque lateral na mesa." },
      { det: "fis-terra", nome: "Levantamento terra romeno", dose: { 1: "3 × 12", 2: "4 × 8", 3: "3 × 5" },
        cue: "Barra colada na perna, quadril para trás, lombar neutra. É o que protege as costas no giro do forehand." },
      { det: "fis-bulgaro", nome: "Afundo búlgaro", dose: { 1: "3 × 10 cada perna", 2: "3 × 8 cada perna", 3: "3 × 6 cada perna" },
        cue: "Pé de trás no banco. Uma perna de cada vez, que é como você joga: o peso está sempre num pé só." },
      { det: "fis-panturrilha", nome: "Elevação de panturrilha", dose: { 1: "3 × 15", 2: "4 × 12", 3: "3 × 10 explosivo" },
        cue: "Amplitude inteira, descendo até esticar. O split-step sai daqui." },
      { det: "fis-prancha-lateral", nome: "Prancha lateral", dose: { 1: "3 × 40 s cada lado", 2: "3 × 45 s cada lado", 3: "3 × 40 s cada lado" },
  ...
  B: {
    ...
    exercicios: [
      { det: "fis-salto-caixote", nome: "Salto no caixote", dose: { 1: "4 × 5", 2: "5 × 3", 3: "6 × 3" },
        cue: "Qualidade, não cansaço. Se a altura do salto cair, a série acabou — mesmo que faltem repetições." },
      { det: "fis-medicine", nome: "Arremesso rotacional de medicine ball", dose: { 1: "3 × 8 cada lado", 2: "4 × 6 cada lado", 3: "5 × 5 máximo cada lado" },
        cue: "É o gesto do topspin com carga. Jogue com o quadril e o pé de trás; o braço só entrega." },
      { det: "fis-remada", nome: "Remada curvada", dose: { 1: "3 × 12", 2: "4 × 8", 3: "3 × 6" },
        cue: "Puxar equilibra o ombro que o saque e o topspin desgastam." },
      { det: "fis-desenvolvimento", nome: "Desenvolvimento de ombro", dose: { 1: "3 × 12", 2: "4 × 8", 3: "3 × 6" },
        cue: "Sem arquear a lombar. Se precisa jogar o quadril para subir, está pesado." },
      { det: "fis-face-pull", nome: "Face pull", dose: { 1: "3 × 15", 2: "3 × 15", 3: "3 × 15" },
        cue: "Não é estética, é manguito rotador. Este é o exercício que te mantém jogando aos 40." },
      { det: "fis-pallof", nome: "Pallof press", dose: { 1: "3 × 10 cada lado", 2: "3 × 10 cada lado", 3: "3 × 8 cada lado" },
  ...
  C: {
    ...
    exercicios: [
      { det: "fis-escada", nome: "Escada de agilidade", dose: { 1: "6 × 20 s", 2: "6 × 20 s", 3: "8 × 20 s" },
        cue: "Pé no chão o mínimo de tempo possível. Não é chegar longe, é bater rápido." },
      { det: "fis-side-step", nome: "Side-step com elástico na cintura", dose: { 1: "4 × 30 s", 2: "4 × 40 s", 3: "4 × 30 s" },
        cue: "É o deslocamento do jogo com resistência. Nunca cruze os pés." },
      { det: "fis-sprint", nome: "Sprint 10 m", dose: { 1: "6 tiros", 2: "8 tiros", 3: "10 tiros" },
        cue: "Recuperação completa entre os tiros — isto é arranque, não corrida. Andar de volta já basta." },
      { det: "fis-intervalado", nome: "Intervalado (corda ou bike)", dose: { 1: "8 × 30 s forte / 30 s leve", 2: "10 × 30 s / 30 s", 3: "8 × 30 s / 30 s" },
        cue: "É a densidade de um set: esforço curto, pausa curta, onze vezes seguidas." },
      { det: "fis-prancha-dinamica", nome: "Prancha dinâmica", dose: { 1: "3 × 45 s", 2: "3 × 45 s", 3: "3 × 45 s" },
